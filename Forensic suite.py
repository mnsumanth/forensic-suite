...
class Welcome():
	def __init__(self,master):
		...
		########### Acquisition ############
		self.buttonSubmit = Button(master,text='Acquisition',command=self.acquisition,height = 3, width = 10).grid(row=1,column=0)
		...
		############ Analysis ###########
		self.buttonSubmit = Button(master,text='Analysis',command=self.analysis,height = 3, width = 10)
		...
		self.buttonSubmit = Button(master,text='Quit',command=self.finish,height = 3, width = 10)
...
class Ddexe():
	...
	def getData(self):
		...
		cmnd2 = 'dd if=%s of=%s bs=1M'% (input_drive,output_location)
		print(cmd2)
...
class Volatality():
	def __init__(self,master):
		...
		self.button=Button(self.master,text='Start Hive Scan',fg='blue', width =17,height=1,command=self.netscan).grid(row=6,column=1,columnspan=2,rowspan=1)
		self.button=Button(self.master,text='Start MFT Parser',fg='blue', width =17,height=1,command=self.netscan).grid(row=5,column=1,columnspan=2,rowspan=1)
